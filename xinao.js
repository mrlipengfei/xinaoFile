        ...
        case "form":
            if (this.ctrl.data == null) {
				...
				if (this.ctrl.getAttribute("reqParam") != null)
				{
					...
					var reqParam= {"reqHeader":{"appId":appId,"operTitle":operId,"sessionId":sessionId,"memId":memId}};
            ...
            if (this.ctrl.data == null) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        jumpUrl(null,data.rspBody,null,data);
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        alert(errorThrown);
                    }
            ...
            if (this.ctrl.data == null) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        jumpUrl(null,jsonData.rspBody,null,jsonData);
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        alert(errorThrown);
                    }
...
function setValue4Desc(jsonItem, cloneRow) {
    for(key in jsonItem) {
        ...
        {
            setValue4DescProcess(jsonItem[key],key);
        }
        else
        {
            var ctrl = $(cloneRow).find("#" + key)[0];
...
function setValue4DescProcess(jsonItem,key)
{
